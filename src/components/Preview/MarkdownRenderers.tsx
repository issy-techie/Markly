...
export const createMarkdownComponents = ({
  ...
  a({ href, children, ...props }: any) {
    // Wiki Link: wikilink: scheme generated by remarkWikiLink plugin
    if (href && href.startsWith("wikilink:")) {
      ...
      return (
        <a
          ...
          className="text-emerald-600 dark:text-emerald-400 underline decoration-dotted hover:text-emerald-800 dark:hover:text-emerald-300 cursor-pointer"
          title={target}
        >
          {children}
        </a>
